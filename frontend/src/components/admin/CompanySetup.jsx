        ...
        <form onSubmit={submitHandler}>
          <div className="flex items-center gap-5 p-8">
            <Button
              ...
              variant="outline"
              className="flex items-center gap-2 px-6 py-3 border border-blue-600 text-blue-600 font-semibold rounded-lg hover:bg-blue-600 hover:text-white transition duration-300 ease-in-out shadow-md"
            >
